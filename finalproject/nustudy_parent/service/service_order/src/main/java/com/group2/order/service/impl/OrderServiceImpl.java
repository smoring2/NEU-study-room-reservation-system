...
//    @Autowired
//    private RabbitService rabbitService;rabbitService
...
//    private WeixinService weixinService;weixinService
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        //获取就诊人信息
        Student student = studentFeignClient.getStudentOrder(patientId);
        ...
        paramMap.put("birthdate", student.getBirthdate());
