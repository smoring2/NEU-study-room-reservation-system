package com.group2.campus.receiver;
...
import com.group2.nustudy.vo.order.OrderMqVo;
...
public class CampusReceiver {
    ...
    public void receiver(OrderMqVo orderMqVo, Message message, Channel channel) throws IOException {
        if(null != orderMqVo.getAvailableNumber()) {
            //Order successfully updated reservation number
            Schedule schedule = scheduleService.getScheduleId(orderMqVo.getScheduleId());
            schedule.setReservedNumber(orderMqVo.getReservedNumber());
            schedule.setAvailableNumber(orderMqVo.getAvailableNumber());
            scheduleService.update(schedule);
        } else {
            //Cancellation of reservations to update the number of reservations
            Schedule schedule = scheduleService.getScheduleId(orderMqVo.getScheduleId());
